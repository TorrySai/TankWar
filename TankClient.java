...
public class TankClient extends Frame {
    ...
    public void paint(Graphics g) {  
        if (start) {  
            ...
            g.drawString("ExplodeCount : " + explodes.size(), 10, 60);  
            g.drawString("TanksCount : " + (tanks.size()), 10, 80);  
            g.drawString("WallsCount : " + walls.size(), 10, 100);  
            g.drawString("BloodsCount : " + bloods.size(), 10, 120);  
            g.drawString("Score : " + score, 10, 140);  
            ...
            for (int i = 0; i < tanks.size(); i++) {  
                ...
                t.draw(g);  
                if (t.isGood())  
                    g.drawString("TankLife : " + t.getLife(), 10, 160);  
    ...
    private void addTank(int tankNum){  
        while(true&&tankNum>0){  
            ...
            t.setX(100+rand.nextInt(GAME_WIDTH - t.getSize()));  
            t.setY(100+rand.nextInt(GAME_HEIGHT - t.getSize() - 25) + 25);  
            for (int i = 0; i < tanks.size(); i++)  
